  ...
  return (
    <div className="space-y-8">
      <section className="bg-primary bg-opacity-5 p-6 rounded-lg">
        ...
        <p className="mb-4">
          Esta página mostra como o tema se comporta quando aplicado a diversos elementos de interface.
          Todos os estilos são baseados nas configurações definidas para este projeto.
        </p>
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <section className="border border-primary border-opacity-20 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="mb-3">
              Este é um parágrafo de texto normal. O texto usa a fonte {project.Styles?.font_family || 'padrão'} e a cor principal 
              definida no tema. Este texto deve ter boa legibilidade sobre a cor de fundo.
            </p>
            
            <p className="mb-3">
              <strong>Texto em negrito</strong> e <em>texto em itálico</em> também devem ser legíveis e 
              manter a consistência com o resto do tema.
            </p>
            ...
            <div className="my-3">
              <a href="#" className="text-primary hover:underline">Este é um link de texto</a>
            </div>
            
            <div className="grid grid-cols-3 gap-4 mt-4">
              <div className="aspect-square flex items-center justify-center" style={{ backgroundColor: theme.primaryColor }}>
                <span className="text-white">Primary</span>
              </div>
              <div className="aspect-square flex items-center justify-center" style={{ backgroundColor: theme.secondaryColor }}>
                <span className="text-white">Secondary</span>
              </div>
              <div className="aspect-square flex items-center justify-center border" style={{ borderColor: theme.primaryColor }}>
          ...
          <div className="p-6">
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-3 mb-4">
                ...
                <button style={{ backgroundColor: theme.secondaryColor, color: 'white' }} className="px-4 py-2 rounded">
                  Botão Secundário
                </button>
            ...
            <div>
              ...
              <div className="border border-primary border-opacity-20 rounded-lg p-4">
                ...
                <button className="text-sm px-3 py-1 bg-primary text-white rounded">
                  Ação
                </button>
              </div>
            </div>
