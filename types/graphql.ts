...
export type ComponentSharedBlocks = {
  __typename?: 'ComponentSharedBlocks';
  CTA?: Maybe<ComponentSharedCta>;
  ImageBlock?: Maybe<ComponentSharedImageBlock>;
  TextBlock?: Maybe<ComponentSharedTextBlock>;
...
export type ComponentSharedImageBlock = {
  __typename?: 'ComponentSharedImageBlock';
  id: Scalars['ID']['output'];
...
export type ComponentSharedImageBlockMediaArgs = {
...
export type ComponentSharedImageBlockMedia_ConnectionArgs = {
  filters?: InputMaybe<UploadFileFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type ComponentSharedTest = {
  __typename?: 'ComponentSharedTest';
  id: Scalars['ID']['output'];
...
export type GenericMorph = About | Article | Author | Category | ComponentSharedBlocks | ComponentSharedCta | ComponentSharedImageBlock | ComponentSharedMedia | ComponentSharedQuote | ComponentSharedRichText | ComponentSharedSeo | ComponentSharedSlider | ComponentSharedTest | ComponentSharedTextBlock | Global | I18NLocale | Page | ReviewWorkflowsWorkflow | ReviewWorkflowsWorkflowStage | UploadFile | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type PageBlocksDynamicZone = ComponentSharedCta | ComponentSharedImageBlock | ComponentSharedTextBlock | Error;
...
export type GetAllSlugsQuery = { __typename?: 'Query', pages: Array<{ __typename?: 'Page', documentId: string, slug?: string | null } | null> };
...
export type GetPageBySlugQuery = { __typename?: 'Query', pages: Array<{ __typename?: 'Page', documentId: string, title?: string | null, slug?: string | null, blocks?: Array<{ __typename: 'ComponentSharedCta', id: string, label?: string | null, url?: string | null } | { __typename: 'ComponentSharedImageBlock', id: string, media: Array<{ __typename?: 'UploadFile', url: string, alternativeText?: string | null } | null> } | { __typename: 'ComponentSharedTextBlock', id: string, text?: string | null } | { __typename: 'Error' } | null> | null } | null> };

export type GetAllPagesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllPagesQuery = { __typename?: 'Query', pages: Array<{ __typename?: 'Page', documentId: string, title?: string | null, slug?: string | null } | null> };
